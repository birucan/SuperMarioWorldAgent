...
env =  retro.make(game='SuperMarioWorld-Snes',state='YoshiIsland3.state')
...
def evaluateGenome(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        while(not done):
            ...
            ## height
            if(marioY!=0 and (marioY)<maxY):
                print(marioY)
                fitness_current+=(maxY-marioY)
                maxY=marioY
...
# save a check point file every 5 iterations
